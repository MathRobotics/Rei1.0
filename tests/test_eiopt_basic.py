...
from eiopt.spec import build_problem_from_spec
...
class TestEiOptBasic(unittest.TestCase):
    ...
    def test_get_state_expr_reads_cache(self) -> None:
        ...
        def build_state(x_all: np.ndarray, *, time=None, required=None) -> dict[StateKey, object]:
    ...
    def test_get_state_builder_autofills_jac_field(self) -> None:
        ...
        _problem, _ctx, required = build_problem_from_spec(spec, build_state=build_state)
    ...
    def test_backend_wrapper_injects_joint_q(self) -> None:
        ...
        wrapped = with_standard_joint_q(lambda x_all: {})
