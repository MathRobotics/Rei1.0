...
# 6D Jacobian conventions vary across robotics libraries:
# some return [linear; angular], others [angular; linear].
...
def as_6xn_jacobian(J6: Array) -> Array:
    ...
    Accepts either (6, n) or (n, 6). Raises on other shapes.
    """
