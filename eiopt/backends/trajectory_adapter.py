...
from ..dsl.trajectory_compile import PreparedTrajectoryProblemDsl, prepare_trajectory_problem_dsl
...
def compile_trajectory_problem_with_adapter(
    ...
    *,
    ...
    runtime = compile_problem(prepared.dsl, build_state=state_builder.build_state)
