...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "IocTermInfo": ("eiopt.optimize.ioc", "IocTermInfo"),
    "IocPreparationResult": ("eiopt.optimize.ioc", "IocPreparationResult"),
    "prepare_ioc_weights": ("eiopt.optimize.ioc", "prepare_ioc_weights"),
    "format_ioc_report": ("eiopt.optimize.ioc", "format_ioc_report"),
