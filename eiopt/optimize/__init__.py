...
_EXPORTS: dict[str, tuple[str, str]] = {
    "ProblemPoint": ("eiopt.problem", "ProblemPoint"),
    "EvaluateProblem": ("eiopt.problem", "EvaluateProblem"),
    "LinearizedProblem": ("eiopt.problem", "LinearizedProblem"),
    "OperatorProblem": ("eiopt.problem", "OperatorProblem"),
    "ProjectProblem": ("eiopt.problem", "ProjectProblem"),
    "ConstraintProblem": ("eiopt.problem", "ConstraintProblem"),
    "NLSRuntimeLinearProblem": ("eiopt.problem", "NLSRuntimeLinearProblem"),
    "NLSRuntimeConstraintProblem": ("eiopt.problem", "NLSRuntimeConstraintProblem"),
    "as_linearized_problem": ("eiopt.problem", "as_linearized_problem"),
    "NLSProblem": ("eiopt.problem", "NLSProblem"),
    ...
    "split_terms_by_component": ("eiopt.optimize.dsl", "split_terms_by_component"),
    ...
    "format_timing_report": ("eiopt.optimize.report", "format_timing_report"),
    "KKTCheckResult": ("eiopt.optimize.kkt", "KKTCheckResult"),
    "check_kkt_residuals": ("eiopt.optimize.kkt", "check_kkt_residuals"),
    "check_kkt_conditions": ("eiopt.optimize.kkt", "check_kkt_conditions"),
    ...
    "TermAttrPlotSeries": ("eiopt.optimize.plot", "TermAttrPlotSeries"),
    "collect_plot_series_from_term_attrs": ("eiopt.optimize.plot", "collect_plot_series_from_term_attrs"),
    "plot_term_attrs": ("eiopt.optimize.plot", "plot_term_attrs"),
    ...
    "SolveStats": ("eiopt.core.outcome", "SolveStats"),
    "SolveOutcome": ("eiopt.core.outcome", "SolveOutcome"),
    "TimingSpan": ("eiopt.core.timing", "TimingSpan"),
    "TimingReport": ("eiopt.core.timing", "TimingReport"),
    "Profiler": ("eiopt.core.timing", "Profiler"),
